                    ...
                    BitSet &cCurrent, std::vector<FCA::ImplicationInd> &cImplications)
{
    ...
    // helps to make a correspondence between string attributes and bits,
    // by associating a name of attribute to an index for bitsets.
    ...
    // set bits corresponding to attributes in current to 1 in cCurrent
    ...
    // set premises and implications of cImplications, out of implications.
